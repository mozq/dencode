...
%><h3>Về chuyển đổi Quy ước đặt tên</h3>
<p>Chuyển đổi qua lại giữa các quy ước đặt tên như tên biến được sử dụng trong lập trình.</p>
<p>Hỗ trợ chuyển đổi sang các định dạng sau:</p>

<div class="table-responsive">
	<table class="table">
		<tr><th>Tên</th><th>Tên khác</th><th>Định dạng</th></tr>
