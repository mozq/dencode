...
%><h3>О японских цифрах</h3>
<p>Числовые значения представлены японскими цифрами. Есть два типа японских цифр: один используется в современной Японии, а другой используется в старом шрифте под названием Дайдзи.</p>

<p>Ниже приведены примеры современных и старых японских цифр.</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>Числа</th><th>Японские цифры (современный шрифт)</th><th>Японские цифры (старый шрифт; Дайдзи)</th></tr>
		</thead>
		<tbody>
...
<p>В японских цифрах числа от 0 до 9 представлены следующими китайскими иероглифами.</p>
...
<p>Числа 10 и выше представлены следующими символами для каждой цифры. В японских цифрах название цифры переносится через каждые 4 цифры. Это называется «маншин» («万進» по-японски).</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>Количество цифр</th><th>Японские цифры (современный шрифт)</th><th>Японские цифры (старый шрифт; Дайдзи)</th></tr>
		</thead>
		<tbody>
...
<p>Для 10, 100 и 1000 обычно опускают «一», например «十», «百» и «千» вместо «一十», «一百» и «一千» соответственно. Однако в случае с Дайдзи может быть указано «壱».</p>

<p>Цифры после десятичной точки выражаются в масштабированной системе счисления после "・".</p>

<p>Из вышеперечисленных Дайдзи японское законодательство предусматривает только «壱», «弐», «参» и «拾».</p>

<p>В Дайдзи цифры «億» (10<sup>8</sup>) или более не определены, но в DenCode они представлены тем же именем, что и современные японские цифры.</p>
