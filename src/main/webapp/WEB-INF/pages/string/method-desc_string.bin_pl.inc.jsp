...
%><h3>O Ciągu Binarnym</h3>
<p>Reprezentuje wartość binarną ciągu znaków w postaci zer i jedynek (01).</p>
<p>Wartość binarna zależy od użytego kodowania znaków, więc wynik konwersji również będzie różny.</p>

<p>Przykład dla japońskiego słowa „サンプル”:</p>

<div class="table-responsive">
	<table class="table">
		<tr><th>Kodowanie</th><th>Ciąg binarny</th></tr>
