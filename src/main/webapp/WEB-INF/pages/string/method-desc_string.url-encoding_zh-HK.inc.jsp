...
<p>在 URL 中具有特殊意義的字元，或不適合直接放入 URL 的字元，會轉換為百分號 (%) 加兩位十六進制數字的形式。</p>
<p>例如，半形空格表示為 <code>%20</code>，感嘆號 (<code>!</code>) 表示為 <code>%21</code>，日文字元「あ」在 UTF-8 中表示為 <code>%E3%81%82</code>。</p>

<p>URL編碼會先使用所選字元編碼將文字轉換為位元組序列，然後按需要將每個位元組表示為 <code>%HH</code>。在 DenCode 中，RFC 3986 的非保留字元，即英文字母、數字以及 <code>-</code>、<code>.</code>、<code>_</code>、<code>~</code> 不會被轉換，其他字元會進行百分號編碼。</p>
...
<p>在此例中，逗號 (<code>,</code>) 轉換為 <code>%2C</code>，半形空格轉換為 <code>%20</code>，感嘆號 (<code>!</code>) 轉換為 <code>%21</code>。</p>


<h4>application/x-www-form-urlencoded 中的空格表示</h4>
<p>HTML 表單提交等情況使用的 <code>application/x-www-form-urlencoded</code> 中，半形空格可以表示為 <code>+</code>。此格式在 <a href="https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#application/x-www-form-urlencoded-encoding-algorithm" target="_blank">HTML Standard</a> 中定義為表單提交編碼。</p>
