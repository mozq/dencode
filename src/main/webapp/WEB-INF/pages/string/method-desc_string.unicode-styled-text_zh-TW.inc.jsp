...
<div class="table-responsive">
	<table class="table">
		...
		<tr><td>Sans-serif (粗體)</td><td><code>𝗔𝗕𝗖 𝗮𝗯𝗰 𝟭𝟮𝟯</code></td><td>類似無襯線字型的粗體字元。</td></tr>
		<tr><td>Sans-serif (斜體)</td><td><code>𝘈𝘉𝘊 𝘢𝘣𝘤 123</code></td><td>類似無襯線字型的斜體字元。數字不會轉換。</td></tr>
		<tr><td>Sans-serif (粗體 & 斜體)</td><td><code>𝘼𝘽𝘾 𝙖𝙗𝙘 123</code></td><td>類似無襯線字型的粗斜體字元。數字不會轉換。</td></tr>
		<tr><td>Serif (粗體)</td><td><code>𝐀𝐁𝐂 𝐚𝐛𝐜 𝟏𝟐𝟑</code></td><td>類似襯線字型的粗體字元。</td></tr>
		<tr><td>Serif (斜體)</td><td><code>𝐴𝐵𝐶 𝑎𝑏𝑐 123</code></td><td>類似襯線字型的斜體字元。數字不會轉換。</td></tr>
		<tr><td>Serif (粗體 & 斜體)</td><td><code>𝑨𝑩𝑪 𝒂𝒃𝒄 123</code></td><td>類似襯線字型的粗斜體字元。數字不會轉換。</td></tr>
		...
		<tr><td>Circled</td><td><code>ⒶⒷⒸ ⓐⓑⓒ ①②③</code></td><td>圓圈字母和數字。</td></tr>
		<tr><td>Negative Circled</td><td><code>🅐🅑🅒 🅐🅑🅒 ❶❷❸</code></td><td>反白圓圈字母和數字。小寫字母會轉換為大寫字母。</td></tr>
		<tr><td>Squared</td><td><code>🄰🄱🄲 🄰🄱🄲 123</code></td><td>方框字母。小寫字母會轉換為大寫字母。數字不會轉換。</td></tr>
		<tr><td>Negative Squared</td><td><code>🅰🅱🅲 🅰🅱🅲 123</code></td><td>反白方框字母。小寫字母會轉換為大寫字母。數字不會轉換。</td></tr>
	</table>
</div>
