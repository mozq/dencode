...
<div class="table-responsive">
	<table class="table">
		...
		<tr><td>Header</td><td>包含權杖類型 (typ) 和簽名演算法 (alg) 等元資料的 JSON 物件</td></tr>
		<tr><td>Payload</td><td>包含使用者 ID 和到期時間等資訊的 JSON 物件</td></tr>
		<tr><td>Signature</td><td>用於偵測標頭和酬載是否被竄改的簽名資料</td></tr>
	</table>
</div>
...
<div class="table-responsive">
	<table class="table">
		...
		<tr><td>alg</td><td>Algorithm</td><td>用於簽名或加密的演算法（如 HS256、RS256、ES256）</td></tr>
		<tr><td>typ</td><td>Type</td><td>權杖類型（通常為「JWT」）</td></tr>
		<tr><td>cty</td><td>Content Type</td><td>酬載的內容類型（巢狀 JWT 時為「JWT」）</td></tr>
		<tr><td>kid</td><td>Key ID</td><td>用於簽名驗證的金鑰識別碼</td></tr>
		<tr><td>jku</td><td>JWK Set URL</td><td>用於簽名驗證的 JWK Set 參考 URL</td></tr>
		<tr><td>x5u</td><td>X.509 URL</td><td>用於簽名驗證的 X.509 憑證鏈參考 URL</td></tr>
		<tr><td>x5t</td><td>X.509 Certificate SHA-1 Thumbprint</td><td>用於簽名驗證的 X.509 憑證的 SHA-1 指紋</td></tr>
	</table>
</div>
