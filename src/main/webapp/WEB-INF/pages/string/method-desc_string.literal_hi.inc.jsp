...
<p>Program String, प्रोग्रामिंग भाषाओं में स्ट्रिंग को परिभाषित करने के लिए एक वर्णनात्मक अभिव्यक्ति है।</p>
<p>स्ट्रिंग को उद्धरण चिह्नों ("" या '') में संलग्न करें, और निम्नलिखित वर्णों को \ प्रतीक से एस्केप करें।</p>
