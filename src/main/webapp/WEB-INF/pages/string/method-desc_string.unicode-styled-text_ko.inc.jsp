...
<p>예를 들어, “Hello, world! 123”을 필기체 (Script) 스타일로 변환하면 다음과 같습니다.</p>
...
<div class="table-responsive">
	<table class="table">
		...
		<tr><td>Script (굵게)</td><td><code>𝓐𝓑𝓒 𝓪𝓫𝓬 123</code></td><td>굵은 필기체처럼 보이는 문자입니다. 숫자는 변환되지 않습니다.</td></tr>
		<tr><td>Sans-serif</td><td><code>𝖠𝖡𝖢 𝖺𝖻𝖼 𝟣𝟤𝟥</code></td><td>산세리프처럼 보이는 문자입니다.</td></tr>
		<tr><td>Sans-serif (굵게)</td><td><code>𝗔𝗕𝗖 𝗮𝗯𝗰 𝟭𝟮𝟯</code></td><td>산세리프 스타일의 굵은 문자입니다.</td></tr>
		<tr><td>Sans-serif (이탤릭 (기울임))</td><td><code>𝘈𝘉𝘊 𝘢𝘣𝘤 123</code></td><td>산세리프 스타일의 기울임 문자입니다. 숫자는 변환되지 않습니다.</td></tr>
		<tr><td>Sans-serif (굵은 이탤릭)</td><td><code>𝘼𝘽𝘾 𝙖𝙗𝙘 123</code></td><td>산세리프 스타일의 굵은 이탤릭 문자입니다. 숫자는 변환되지 않습니다.</td></tr>
		<tr><td>Serif (굵게)</td><td><code>𝐀𝐁𝐂 𝐚𝐛𝐜 𝟏𝟐𝟑</code></td><td>세리프 스타일의 굵은 문자입니다.</td></tr>
		<tr><td>Serif (이탤릭 (기울임))</td><td><code>𝐴𝐵𝐶 𝑎𝑏𝑐 123</code></td><td>세리프 스타일의 기울임 문자입니다. 숫자는 변환되지 않습니다.</td></tr>
		<tr><td>Serif (굵은 이탤릭)</td><td><code>𝑨𝑩𝑪 𝒂𝒃𝒄 123</code></td><td>세리프 스타일의 굵은 이탤릭 문자입니다. 숫자는 변환되지 않습니다.</td></tr>
