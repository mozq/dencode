...
<p>Na przykład po konwersji „Hello, world! 123” do stylu pisma odręcznego (Script) wynik wygląda następująco.</p>
...
<div class="table-responsive">
	<table class="table">
		...
		<tr><td>Script (pogrubienie)</td><td><code>𝓐𝓑𝓒 𝓪𝓫𝓬 123</code></td><td>Pogrubione znaki w stylu pisma odręcznego. Cyfry nie są konwertowane.</td></tr>
		<tr><td>Sans-serif</td><td><code>𝖠𝖡𝖢 𝖺𝖻𝖼 𝟣𝟤𝟥</code></td><td>Znaki w stylu sans-serif.</td></tr>
		<tr><td>Sans-serif (pogrubienie)</td><td><code>𝗔𝗕𝗖 𝗮𝗯𝗰 𝟭𝟮𝟯</code></td><td>Pogrubione znaki w stylu sans-serif.</td></tr>
		<tr><td>Sans-serif (kursywa)</td><td><code>𝘈𝘉𝘊 𝘢𝘣𝘤 123</code></td><td>Kursywa w stylu sans-serif. Cyfry nie są konwertowane.</td></tr>
		<tr><td>Sans-serif (pogrubienie i kursywa)</td><td><code>𝘼𝘽𝘾 𝙖𝙗𝙘 123</code></td><td>Pogrubiona kursywa w stylu sans-serif. Cyfry nie są konwertowane.</td></tr>
		<tr><td>Serif (pogrubienie)</td><td><code>𝐀𝐁𝐂 𝐚𝐛𝐜 𝟏𝟐𝟑</code></td><td>Pogrubione znaki w stylu serif.</td></tr>
		<tr><td>Serif (kursywa)</td><td><code>𝐴𝐵𝐶 𝑎𝑏𝑐 123</code></td><td>Kursywa w stylu serif. Cyfry nie są konwertowane.</td></tr>
		<tr><td>Serif (pogrubienie i kursywa)</td><td><code>𝑨𝑩𝑪 𝒂𝒃𝒄 123</code></td><td>Pogrubiona kursywa w stylu serif. Cyfry nie są konwertowane.</td></tr>
