...
%><h3>Über String-Literale</h3>
<p>String-Literals sind Darstellungen zur Definition von Zeichenketten in Programmiersprachen.</p>
<p>Der String wird in Anführungszeichen (z. B. "") eingeschlossen, und die folgenden Zeichen werden mit einem Backslash (\) maskiert:</p>
