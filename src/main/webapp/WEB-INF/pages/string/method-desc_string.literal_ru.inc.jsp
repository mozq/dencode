...
%><h3>О строковом литерале</h3>
<p>Строковый литерал - это описательное представление для определения строки на языке программирования.</p>
<p>Заключите строку в кавычки (например, "") и экранируйте следующие символы символом \.</p>
