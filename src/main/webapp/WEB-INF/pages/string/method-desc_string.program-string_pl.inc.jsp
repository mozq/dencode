...
%><h3>O Ciągu Znaków Programu</h3>
<p>Jest to reprezentacja literału łańcuchowego używana w językach programowania.</p>
<p>Ciąg jest ujęty w cudzysłowy ("" lub ''), a znaki specjalne są eskapowane za pomocą backslasha (\).</p>
