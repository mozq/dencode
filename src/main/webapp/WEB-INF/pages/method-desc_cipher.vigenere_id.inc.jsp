...
<p>Baris paling atas adalah teks asli sebelum enkripsi, kolom kiri adalah kunci enkripsi, dan karakter di persimpangan mereka adalah karakter terenkripsi. Kunci enkripsi adalah string karakter dari "A" hingga "Z".</p>
