...
%><h3>O Szyfrze Vigenère'a</h3>
<p>Szyfr Vigenère'a to polialfabetyczny szyfr podstawieniowy.</p>
<p>Szyfrowanie odbywa się przy użyciu klucza (hasła) oraz tablicy Vigenère'a (kwadratu Vigenère'a).</p>
...
<p>Górny wiersz zawiera litery tekstu jawnego, kolumna z lewej strony zawiera litery klucza. Litera na przecięciu tych dwóch wyznacza literę zaszyfrowaną.</p>

<p>Np. jeśli tekst jawny to „MESSAGE” a klucz to „SECRET”: Pierwszą literą tekstu jest „M”, pierwszą literą klucza jest „S”, ich przecięcie w tabeli to „E”.</p>
...
<p>Klucz jest powtarzany, aby dopasować się długością do tekstu jawnego.</p>
