...
%><h3>Over Vigenère Cijfer</h3>
<p>Het Vigenère Cijfer is een type mono-alfabetisch substitutiecijfer waarbij elke letter in een tekst wordt vervangen door een andere.</p>
<p>De vervanging van letters gebeurt met behulp van de encryptiesleutel en het volgende Vigenère-vierkant.</p>
...
<p>De bovenste rij is de platte tekst voor encryptie, de linkerkolom is de encryptiesleutel, en het teken waar ze elkaar kruisen is het teken na encryptie. De encryptiesleutel is een reeks tekens van "A" tot "Z".</p>

<p>Bijvoorbeeld, als de platte tekst "MESSAGE" is en de encryptiesleutel "SECRET", worden de tekens als volgt vervangen en versleuteld. Omdat het eerste teken "M" is en de sleutel "S", wordt het teken na encryptie "E".</p>

<pre>
Voor encryptie : MESSAGE
Sleutel        : SECRETS
Na encryptie   : EIUJEZW
</pre>

<p>Eén letter van de encryptiesleutel wordt gebruikt voor elk teken van de platte tekst. Als de lengte van de sleutel korter is dan de platte tekst, wordt de sleutel herhaald gebruikt.</p>
