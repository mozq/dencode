...
%><h3>Über Englische Zahlwörter</h3>
<p>Stellt Zahlen als englische Wörter dar.</p>

<p>Die Umwandlung von 123456789 in englische Zahlwörter sieht beispielsweise so aus:</p>
<pre>123456789 = One Hundred Twenty-Three Million Four Hundred Fifty-Six Thousand Seven Hundred Eighty-Nine</pre>

<p>Nachkommastellen können als Wörter für jede Ziffer oder als Bruch dargestellt werden. Zum Beispiel wird 0.99 als „Zero point Nine Nine“ oder als Bruch „Zero and 99/100“ ausgedrückt.</p>
...
<p>DenCode verwendet standardmäßig die im modernen englischen Sprachraum übliche Short Scale.</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th></th><th colspan="2">Short Scale</th><th colspan="2">Long Scale (Chuquet)</th><th colspan="2">Long Scale (Peletier)</th></tr>
			<tr><th>Größe</th><th>N (10<sup>3N+3</sup>)</th><th>Name</th><th>N (10<sup>6N</sup>)</th><th>Name</th><th>N (10<sup>6N</sup>)</th><th>Name</th></tr>
		</thead>
		<tbody>
...
<div class="table-responsive">
	<table class="table">
		...
		<thead>
			<tr><th></th><th>Einer</th><th>Zehner</th><th>Hunderter</th></tr>
		</thead>
		<tbody>
...
<p>Das Conway-Wechsler-System wurde für die Short Scale definiert, kann aber auch für die Long Scale verwendet werden. Um den Namen zu erhalten, bestimmt man N (10<sup>3N+3</sup> für Short Scale, 10<sup>6N</sup> für Long Scale) und kombiniert die Silben aus der Tabelle.</p>
<p>Zum Beispiel ist 10<sup>96</sup> in der Short Scale 10<sup>3*31+3</sup>, also N=31. Man kombiniert von den Einer- zur Zehnerstelle: „un“(1) + „triginta“(30) + „illion“ = „Untrigintillion“. Wenn vor „illion“ ein Vokal steht, entfällt dieser.</p>
<pre>10<sup>96</sup> = 10<sup>3*31+3</sup> = One Untrigintillion</pre>

<p>Die Buchstaben in Klammern <sup>(mnsx)</sup> zeigen Assimilationsregeln an. Wenn Buchstaben beim Zusammenfügen übereinstimmen, werden sie eingefügt. Zum Beispiel bei N=36: „se <sup>(sx)</sup>“(6) + „<sup>(ns)</sup> triginta“(30) + „illion“ = „Se<b>s</b>trigintillion“.</p>
<pre>10<sup>111</sup> = 10<sup>3*36+3</sup> = One Sestrigintillion</pre>

<p>Bei „tre <sup>(s(x))</sup>“(3) ist es speziell: Es wird immer ein „s“ eingefügt, wenn ein <sup>(sx)</sup> folgt. N=83: „tre <sup>(s(x))</sup>“(3) + „<sup>(mx)</sup> octoginta“(80) + „illion“ = „Tre<b>s</b>octogintillion“.</p>
...
<p>Das Conway-Wechsler-System basiert auf Latein und weicht teilweise von englischen Wörterbüchern ab:</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>N</th><th>Conway-Wechsler</th><th>Wörterbuch</th><th>Latein</th></tr>
		</thead>
		<tbody>
			<tr><td>15</td><td>Quin<b>qua</b>decillion</td><td>Quindecillion</td><td>5 ist "quinque", aber 15 ist eher "quindecim" als "quinquadecim".</td></tr>
			<tr><td>16</td><td>Sedecillion</td><td>Se<b>x</b>decillion</td><td>Eher "sedecim" als "sexdecim".</td></tr>
			<tr><td>19</td><td>Nove<b>n</b>decillion</td><td>Nove<b>m</b>decillion</td><td>Oft "undeviginti", aber auch "novendecim" oder "novemdecim".</td></tr>
		</tbody>
	</table>
</div>
