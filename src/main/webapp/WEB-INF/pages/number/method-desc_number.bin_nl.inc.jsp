...
%><h3>Over Binaire Getallen</h3>
<p>Binaire getallen vertegenwoordigen waarden in binaire notatie.</p>

<p>In binair worden waarden weergegeven met het grondtal 2 met behulp van "01".</p>

<p>Voorbeelden van conversie in binair zijn als volgt. Ter referentie zijn ook conversievoorbeelden voor octaal en hexadecimaal opgenomen.</p>
...
<p>Ook worden waarden achter de komma in binair geconverteerd als waarden van elke plaats: 2<sup>-1</sup> (1/2), 2<sup>-2</sup> (1/4), 2<sup>-3</sup> (1/8), enzovoort. Als de waarde achter de komma niet kan worden weergegeven als de som van 2<sup>-n</sup>, kan deze niet volledig worden geconverteerd naar binair en treedt er een fout op. In dat geval geeft DenCode dit weer door "..." aan het einde toe te voegen.</p>
