...
%><h3>16-आधार (Hexadecimal) के बारे में</h3>
<p>16-आधार (Hexadecimal), संख्याओं को हेक्साडेसिमल नोटेशन में व्यक्त करता है।</p>

<p>16-आधार में, संख्याओं को 16 के आधार के रूप में "0123456789ABCDEF" का उपयोग करके व्यक्त किया जाता है। 10-आधार के 0 से 9 को 16-आधार में भी 0 से 9 के रूप में दर्शाया जाता है, और 10 से 15 को A से F के रूप में दर्शाया जाता है।</p>

<p>16-आधार में रूपांतरण का उदाहरण नीचे दिया गया है। संदर्भ के लिए, 2-आधार और 8-आधार के रूपांतरण उदाहरण भी दिए गए हैं।</p>
...
<p>इसके अलावा, दशमलव बिंदु के बाद की संख्याओं को 16-आधार में 16<sup>-1</sup> (1/16), 16<sup>-2</sup> (1/256), 16<sup>-3</sup> (1/4096), ... के स्थानीय मान के रूप में परिवर्तित किया जाता है। यदि दशमलव भाग को 16<sup>-n</sup> के योग के रूप में व्यक्त नहीं किया जा सकता है, तो इसे पूरी तरह से 16-आधार में परिवर्तित नहीं किया जा सकता और त्रुटि (error) होती है। उस स्थिति में, DenCode अंत में "..." जोड़कर इसे संक्षिप्त रूप में दर्शाता है।</p>
