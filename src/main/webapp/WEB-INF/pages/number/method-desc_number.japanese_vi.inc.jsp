...
%><h3>Về số Hán tự</h3>
<p>Biểu diễn các giá trị số bằng Hán tự (chữ số Nhật Bản). Có hai loại số Hán tự: loại được sử dụng ở Nhật Bản hiện đại và loại sử dụng các ký tự cũ gọi là Đại tự (Daiji).</p>

<p>Dưới đây là các ví dụ về số Hán tự hiện đại và Đại tự.</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>Số Ả Rập</th><th>Số Hán tự</th><th>Số Hán tự (Đại tự)</th></tr>
		</thead>
		<tbody>
...
<p>Trong số Hán tự Nhật Bản, các số từ 0 đến 9 được biểu diễn bằng các ký tự sau:</p>
...
<p>Các số từ 10 trở lên được biểu diễn bằng các ký tự sau cho mỗi hàng. Trong số Hán tự, tên hàng thay đổi mỗi 4 chữ số. Điều này được gọi là "Manshin" (Vạn tiến).</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>Hàng</th><th>Số Hán tự</th><th>Số Hán tự (Đại tự)</th></tr>
		</thead>
		<tbody>
...
<p>Đối với 10, 100, 1000, thông thường người ta lược bỏ "一" và viết là "十", "百", "千" thay vì "一十", "一百", "一千". Tuy nhiên, trong trường hợp Đại tự, "壱" có thể được ghi rõ.</p>

<p>Phần thập phân được biểu diễn theo ký hiệu vị trí sau dấu chấm "・".</p>

<p>Trong số các Đại tự ở trên, chỉ có "壱" (1), "弐" (2), "参" (3), và "拾" (10) được quy định trong luật pháp Nhật Bản.</p>

<p>Đại tự không định nghĩa các hàng lớn hơn "億" (10<sup>8</sup>), nhưng trong DenCode, chúng được biểu diễn bằng tên hàng giống như số Hán tự thông thường.</p>
