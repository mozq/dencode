...
%><h3>O Liczebnikach Japońskich (Kanji)</h3>
<p>Konwertuje liczby na zapis w języku japońskim przy użyciu znaków Kanji. Dostępne są dwa warianty: standardowy oraz tzw. „Daiji” (używany w dokumentach formalnych i finansowych, trudniejszy do sfałszowania).</p>

<p>Przykłady współczesnych cyfr Kanji i Daiji:</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>Arabskie</th><th>Kanji (Standard)</th><th>Kanji (Daiji)</th></tr>
		</thead>
		<tbody>
...
<p>W japońskich liczebnikach cyfry od 0 do 9 są reprezentowane przez następujące Kanji:</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>Arabskie</th><th>Kanji</th><th>Daiji</th></tr>
		</thead>
		<tbody>
...
<p>Liczby 10 i większe są reprezentowane przez następujące Kanji dla każdej pozycji dziesiętnej. W liczebnikach Kanji nazwy jednostek zmieniają się co 4 cyfry (co 10<sup>4</sup>), co nazywa się systemem miriadowym (Myriad system).</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>Rząd wielkości</th><th>Kanji</th><th>Daiji</th></tr>
		</thead>
		<tbody>
...
<p>Dla 10, 100, 1000 powszechnie pomija się „一” (jeden), pisząc „十”, „百”, „千” zamiast „一十”, „一百”, „一千”. Jednak w Daiji „壱” jest czasem jawnie zapisywane.</p>

<p>Część ułamkowa jest reprezentowana po „・” cyfra po cyfrze.</p>

<p>Wśród powyższych Daiji, japońskie prawo definiuje tylko „壱”, „弐”, „参” i „拾”.</p>

<p>W Daiji jednostki powyżej „億” (10<sup>8</sup>) nie są zdefiniowane, ale DenCode używa tych samych nazw jednostek, co w standardowych liczebnikach Kanji.</p>
