...
%><h3>2-आधार (Binary) के बारे में</h3>
<p>2-आधार (Binary), संख्याओं को बाइनरी नोटेशन में व्यक्त करता है।</p>

<p>2-आधार में, संख्याओं को 2 के आधार के रूप में "01" का उपयोग करके व्यक्त किया जाता है।</p>

<p>2-आधार में रूपांतरण का उदाहरण नीचे दिया गया है। संदर्भ के लिए, 8-आधार और 16-आधार के रूपांतरण उदाहरण भी दिए गए हैं।</p>
...
<p>इसके अलावा, दशमलव बिंदु के बाद की संख्याओं को 2-आधार में 2<sup>-1</sup> (1/2), 2<sup>-2</sup> (1/4), 2<sup>-3</sup> (1/8), ... के स्थानीय मान के रूप में परिवर्तित किया जाता है। यदि दशमलव भाग को 2<sup>-n</sup> के योग के रूप में व्यक्त नहीं किया जा सकता है, तो इसे पूरी तरह से 2-आधार में परिवर्तित नहीं किया जा सकता और त्रुटि (error) होती है। उस स्थिति में, DenCode अंत में "..." जोड़कर इसे संक्षिप्त रूप में दर्शाता है।</p>
