...
%><h3>Over Octale Getallen</h3>
<p>Octale getallen vertegenwoordigen waarden in octale notatie.</p>

<p>In octaal worden waarden weergegeven met het grondtal 8 met behulp van "01234567".</p>

<p>Voorbeelden van conversie in octaal zijn als volgt. Ter referentie zijn ook conversievoorbeelden voor binair en hexadecimaal opgenomen.</p>
...
<p>Ook worden waarden achter de komma in octaal geconverteerd als waarden van elke plaats: 8<sup>-1</sup> (1/8), 8<sup>-2</sup> (1/64), 8<sup>-3</sup> (1/512), enzovoort. Als de waarde achter de komma niet kan worden weergegeven als de som van 8<sup>-n</sup>, kan deze niet volledig worden geconverteerd naar octaal en treedt er een fout op. In dat geval geeft DenCode dit weer door "..." aan het einde toe te voegen.</p>
