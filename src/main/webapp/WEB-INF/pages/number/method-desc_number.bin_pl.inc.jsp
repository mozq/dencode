...
%><h3>O Systemie Binarnym (Dwójkowym)</h3>
<p>System binarny to system liczbowy o podstawie 2.</p>

<p>Używa tylko cyfr „0” i „1”.</p>
...
<p>Wartości ułamkowe są obliczane jako suma potęg dwójki: 2<sup>-1</sup> (1/2), 2<sup>-2</sup> (1/4), 2<sup>-3</sup> (1/8) itd. Jeśli ułamek nie może być przedstawiony dokładnie (rozwinięcie nieskończone), DenCode dodaje na końcu „...” aby zasygnalizować przybliżenie.</p>
