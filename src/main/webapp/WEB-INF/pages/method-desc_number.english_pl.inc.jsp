...
%><h3>O Liczebnikach Angielskich</h3>
<p>Konwertuje liczby na ich słowny zapis w języku angielskim.</p>

<p>Na przykład konwersja liczby 123456789:</p>
<pre>123456789 = One Hundred Twenty-Three Million Four Hundred Fifty-Six Thousand Seven Hundred Eighty-Nine</pre>

<p>Wartości po przecinku mogą być wyrażone słownie (cyfra po cyfrze) lub jako ułamek. Na przykład 0.99:</p>
<pre>0.99 = Zero point Nine Nine
0.99 = Zero and 99/100</pre>


<h4>Wielkie liczby</h4>
<p>Dla większych liczb stosuje się tzw. krótką skalę (short scale) lub długą skalę (long scale). W krótkiej skali nazwa zmienia się co 3 cyfry, a w długiej co 6 cyfr. W długiej skali istnieje system Chuquet (używający „Thousand -illion”) oraz system Peletier (używający „-illiard”).</p>
<p>Krótka skala jest używana głównie w krajach anglojęzycznych, takich jak USA, Kanada i Wielka Brytania (od 1974 r.). Długa skala jest używana w wielu krajach europejskich nieanglojęzycznych.</p>
<p>DenCode domyślnie używa krótkiej skali, która jest powszechna we współczesnym środowisku anglojęzycznym.</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th></th><th colspan="2">Krótka skala</th><th colspan="2">Długa skala (Chuquet)</th><th colspan="2">Długa skala (Peletier)</th></tr>
			<tr><th>Rząd</th><th>N (10<sup>3N+3</sup>)</th><th>Nazwa</th><th>N (10<sup>6N</sup>)</th><th>Nazwa</th><th>N (10<sup>6N</sup>)</th><th>Nazwa</th></tr>
		</thead>
		<tbody>
...
<p>Powyższe nazwy są powszechnie spotykane we współczesnych słownikach angielskich.</p>
<p>Nazwy systemów długiej skali Chuquet i Peletier pochodzą od faktu, że w 1484 roku francuski matematyk Nicolas Chuquet zdefiniował nazwy do N=9 „Nonillion” (Byllion, Tryllion, Quadrillion, Quyllion, Sixlion, Septyllion, Ottyllion, Nonyllion w języku francuskim), a w 1549 roku Jacques Peletier du Mans spopularyzował „Milliard” (Milliart) (początkowo „Milliard” oznaczał 10<sup>12</sup>, a pod koniec XVII wieku jego wartość spadła do 10<sup>9</sup>).</p>


<h4>System Conwaya-We chslera</h4>
<p>Dla liczb N=10 lub większych (10<sup>33</sup> i więcej), John Horton Conway i Allan Wechsler zdefiniowali <dfn>system Conwaya-We chslera</dfn>. System ten tworzy nazwy według następujących reguł:</p>

<div class="table-responsive">
	<table class="table">
		<caption>System Conwaya-We chslera</caption>
		<thead>
			<tr><th></th><th>Jedności (Units)</th><th>Dziesiątki (Tens)</th><th>Setki (Hundreds)</th></tr>
		</thead>
		<tbody>
...
<p>Aby uzyskać nazwę, należy obliczyć N (10<sup>3N+3</sup> dla krótkiej skali) i połączyć odpowiednie części z tabeli.</p>
<p>Na przykład dla 10<sup>96</sup> (krótka skala), N=31. Składa się z „un”(1) + „triginta”(30) + „illion” = „Untrigintillion”.</p>
<pre>10<sup>96</sup> = 10<sup>3*31+3</sup> = One Untrigintillion</pre>

<p>Nawiasy superscript <sup>(mnsx)</sup> oznaczają reguły asymilacji dźwięków przy łączeniu jednostek. Np. dla N=36: „se <sup>(sx)</sup>”(6) + „<sup>(ns)</sup> triginta”(30) + „illion” = „Se<b>s</b>trigintillion”.</p>
<pre>10<sup>111</sup> = 10<sup>3*36+3</sup> = One Sestrigintillion</pre>

<p>Przypadek „tre <sup>(s(x))</sup>”(3) jest wyjątkowy: „s” jest dodawane niezależnie od tego, która z liter <sup>(sx)</sup> występuje po nim. Na przykład dla N=83: „tre <sup>(s(x))</sup>”(3) + „<sup>(mx)</sup> octoginta”(80) + „illion” = „Tre<b>s</b>octogintillion”.</p>
<pre>10<sup>252</sup> = 10<sup>3*83+3</sup> = One Tresoctogintillion</pre>

<p>W przypadku jeszcze większych liczb, gdzie N=1 000 lub więcej (10<sup>3003</sup> lub więcej), nazwę tworzy się dla każdych 3 cyfr N według powyższej procedury, a następnie łączy je na końcu. Jeśli N=1 000 000<b>X</b> + 1 000<b>Y</b> + <b>Z</b>, a nazwy poszczególnych rzędów to „<b>X</b>illion”, „<b>Y</b>illion”, „<b>Z</b>illion”, łączy się je jako „<b>X</b>illi<b>y</b>illi<b>z</b>illion”, pomijając „on” w środkowym „-illion”. Na przykład dla N=1 003: „Million”(1) + „Trillion”(3) = „Millitrillion”. Dla N=12 210: „Duodecillion”(12) + „Deciducentillion”(210) = „Duodecillideciducentillion”.</p>
<p>Ponadto, jeśli wartość 3 cyfr wynosi 0, używa się „Nillion”. Na przykład dla N=1 000 003: „Million”(1) + „Nillion”(0) + „Trillion”(3) = „Millinillitrillion”.</p>
...
<p>System Conwaya-Wechslera opiera się głównie na łacinie, dlatego istnieją różnice w porównaniu z nazwami w słownikach angielskich:</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>N</th><th>System Conwaya-Wechslera</th><th>Słownik angielski</th><th>Słowo łacińskie</th></tr>
		</thead>
		<tbody>
			<tr><td>15</td><td>Quin<b>qua</b>decillion</td><td>Quindecillion</td><td>5 to „quinque”, ale 15 to powszechnie „quindecim” zamiast „quinquadecim”.</td></tr>
			<tr><td>16</td><td>Sedecillion</td><td>Se<b>x</b>decillion</td><td>„sedecim” jest bardziej powszechne niż „sexdecim”.</td></tr>
			<tr><td>19</td><td>Nove<b>n</b>decillion</td><td>Nove<b>m</b>decillion</td><td>Zwykle „undeviginti”, ale czasem „novendecim” lub „novemdecim”. Podobnie N=17 to powszechnie „septendecim” zamiast „septemdecim”.</td></tr>
		</tbody>
	</table>
</div>

<p>„Quinqua” oznaczające 5 to w łacinie „quinque”, ale 15 to „quindecim” (w angielskim „quindecillion”). Dlatego w systemie Conwaya-Wechslera czasem zastępuje się „quinqua” przez „quin”. Tę modyfikację zaproponował Olivier Miakinen (zob. <cite><a href="http://www.miakinen.net/vrac/zillions" target="_blank">Olivier Miakinen. Les zillions selon Conway, Wechsler... et Miakinen, 2003</a></cite>). DenCode również używa „quin”, co jest bliższe słownikom angielskim.</p>


<h4>System CW4EN</h4>
<p>DenCode używa zmodyfikowanej wersji systemu Conwaya-We chslera, bardziej dostosowanej do słowników angielskich, nazwanej tutaj „<dfn><abbr title="Conway-Wechsler for English">CW4EN</abbr> system</dfn>”.</p>

<div class="table-responsive">
	<table class="table">
		<caption>System CW4EN</caption>
		<thead>
			<tr><th></th><th>Jedności (Units)</th><th>Dziesiątki (Tens)</th><th>Setki (Hundreds)</th></tr>
		</thead>
		<tbody>
...
<p>W systemie CW4EN, „tre <sup>(s(x))</sup>”, „se <sup>(sx)</sup>”, „septe <sup>(mn)</sup>”, „nove <sup>(mn)</sup>” z systemu Conwaya-Wechslera są ustalone jako „tre”, „se<b>x</b>”, „septe<b>n</b>”, „nove<b>m</b>”. Wyjątkiem jest przypadek N=103, gdzie używa się „Tre<b>s</b>centillion” zamiast „Trecentillion”. Ma to na celu uniknięcie powtórzenia z „Trecentillion” dla N=300.</p>
<p>Istnieją przykłady systemów podobnych do CW4EN, ale nie uwzględniają one lub nie wspominają o różnicy między „Tre<b>s</b>centillion” / „Trecentillion”. (Przykład: <cite><a href="https://www.nasdaq.com/glossary" target="_blank">Glossary of Stock Market Terms &amp; Definitions | Nasdaq</a></cite>)</p>

<p>Różnice między systemem Conwaya-We chslera a CW4EN (przykłady):</p>

<div class="table-responsive">
	<table class="table">
		<thead>
			<tr><th>N</th><th>System Conwaya-We chslera</th><th>System CW4EN</th></tr>
		</thead>
		<tbody>
