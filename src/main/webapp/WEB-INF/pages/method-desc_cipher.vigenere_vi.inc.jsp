...
%><h3>Về Mật mã Vigenère</h3>
<p>Mật mã Vigenère là một dạng mật mã thay thế đa bảng, trong đó mỗi ký tự trong văn bản được thay thế bằng một ký tự khác.</p>
<p>Việc thay thế ký tự được thực hiện bằng bảng Vigenère và khóa mã hóa.</p>
...
<p>Hàng trên cùng là văn bản rõ trước khi mã hóa (Plaintext), cột bên trái là khóa mã hóa (Key), và ký tự giao nhau giữa hàng và cột là ký tự sau khi mã hóa. Khóa mã hóa là một chuỗi các ký tự từ "A" đến "Z".</p>

<p>Ví dụ, nếu văn bản trước mã hóa là "MESSAGE" và khóa là "SECRET", các ký tự sẽ được thay thế như sau. Ký tự đầu tiên là "M" và khóa tương ứng là "S", nên ký tự sau khi mã hóa là "E".</p>
...
<p>Mỗi ký tự của văn bản rõ được mã hóa bằng 1 ký tự tương ứng của khóa. Nếu khóa ngắn hơn văn bản rõ, khóa sẽ được lặp lại.</p>
