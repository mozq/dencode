...
%><h3>Về số Bát phân</h3>
<p>Số bát phân biểu diễn các giá trị số bằng hệ thống cơ số 8.</p>

<p>Trong hệ bát phân, các số được biểu diễn bằng cơ số 8 với các ký tự "01234567".</p>

<p>Dưới đây là các ví dụ chuyển đổi trong hệ bát phân. Các ví dụ chuyển đổi sang hệ nhị phân và thập lục phân cũng được bao gồm để tham khảo.</p>
...
<p>Ngoài ra, các giá trị sau dấu thập phân được chuyển đổi thành tổng của 8<sup>-1</sup> (1/8), 8<sup>-2</sup> (1/64), 8<sup>-3</sup> (1/512), ... Nếu giá trị thập phân không thể được biểu diễn chính xác bằng tổng của 8<sup>-n</sup>, nó sẽ không thể chuyển đổi hoàn toàn sang hệ bát phân và sẽ xảy ra sai số. Trong trường hợp đó, DenCode sẽ thêm "..." vào cuối để biểu thị sự lược bỏ.</p>
