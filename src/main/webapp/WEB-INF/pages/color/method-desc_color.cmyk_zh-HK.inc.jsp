...
%><h3>關於 CMYK 顏色</h3>
<p>CMYK 顏色是使用青色、洋紅、黃色和黑色（Key plate）四個成分表示顏色的顏色模型。它主要用於印刷和桌面出版領域，基於透過疊加油墨產生顏色的減色混合。</p>
...
<p>如要包含透明度，請加入 Alpha 值。例如，半透明紅色可以表示為 <code>device-cmyk(0% 100% 100% 0% / 0.5)</code>。</p>
