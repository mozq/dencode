...
%><h3>關於 HWB 顏色</h3>
<p>HWB 顏色是使用色相、白色度和黑色度三個成分表示顏色的顏色模型。色相指定基本色味，白色度和黑色度指定混入多少白色和黑色，因此較容易直觀地調整為更淺、更暗或更接近灰色的顏色。</p>
...
<p>如要包含透明度，請加入 Alpha 值。例如，半透明紅色可以表示為 <code>hwb(0deg 0% 0% / 0.5)</code>。</p>
...
<h4>HWB 和 HSL 的差異</h4>
<p><a href="${dc:h(basePath)}/color/hsl">HSL</a> 使用飽和度和明度調整顏色，適合指定顏色的鮮艷程度和明亮程度。HWB 透過混入白色和黑色的量來調整顏色，因此較容易說明「保持相同色相並變白」或「加入黑色使其變暗」等操作。</p>
