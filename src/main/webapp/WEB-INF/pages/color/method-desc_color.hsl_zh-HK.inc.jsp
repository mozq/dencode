...
%><h3>關於 HSL 顏色</h3>
<p>HSL 顏色是使用色相、飽和度和明度來表示顏色的顏色模型。它不像 RGB 那樣直接指定紅、綠、藍光的強度，而是將色味、鮮艷程度和明亮程度分開，因此常用於顏色調整和 CSS 設計。</p>
...
<div class="table-responsive">
	<table class="table">
		...
		<tbody>
			...
			<tr><td>S: 飽和度</td><td>表示顏色的鮮艷程度。0% 為無彩色，100% 為最鮮艷的顏色。</td><td><code>50%</code></td></tr>
...
<p>如要包含透明度，請加入 Alpha 值。例如，半透明紅色可以表示為 <code>hsl(0deg 100% 50% / 0.5)</code>。</p>
...
<h4>HSL 和 RGB 的差異</h4>
<p><a href="${dc:h(basePath)}/color/rgb">RGB</a> 直接指定紅、綠、藍成分，因此更接近螢幕顯示和圖像資料。HSL 將色相、飽和度和明度分開，因此更容易進行「保持相同色相並變亮」或「只降低飽和度」等調整。</p>
