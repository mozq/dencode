...
public class NumberOctDencoder {
	...
	private static final int ENC_RADIX = 8;
	...
	public static String encNumOct(DencodeCondition cond) {
		return encNumOct(cond.valueAsNumbers(), cond.valueAsLines());
	}
	...
	private static String encNumOct(List<BigDecimal> vals, List<String> strVals) {
